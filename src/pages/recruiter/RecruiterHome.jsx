      ...
      <div className="max-w-7xl mx-auto p-6 md:p-10 min-h-screen text-foreground space-y-12">
        ...
        <div className="bg-card border border-border rounded-2xl shadow overflow-x-auto">
          ...
          <div className="min-w-[600px]">
            ...
            {/* Table Head */}
            <div className="grid grid-cols-4 p-4 bg-muted items-center font-bold text-sm sm:text-base uppercase tracking-wider text-gray-700 ">
            ...
            <div className="divide-y divide-border">
              {jobs.slice(0, 5).map((job) => (
                <div
                  key={job.id}
                  className="grid grid-cols-4 p-4 items-center hover:bg-muted transition text-sm sm:text-base">
                  <div className="font-medium text-foreground text-center">{job.title}</div>

                  <div className={new Date(job.deadline) > new Date() ? "text-center text-green-600 font-semibold" : "text-center text-red-500 font-semibold"}>
