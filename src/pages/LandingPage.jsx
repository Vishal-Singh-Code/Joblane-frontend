...
function LandingPage() {
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      {/* Hero Section */}
      <section className="flex flex-col md:flex-row items-center justify-between px-10 md:px-15 bg-card">
      ...
      <section className="bg-white overflow-hidden border-b flex items-center">
        <div className="flex-shrink-0 min-w-[120px] pl-4 pr-8 pt-4 pb-4 text-primary">
          <h2 className="font-bold text-4xl sm:text-5xl leading-tight">10k+</h2>
          <p className="text-base sm:text-lg">openings daily</p>
        </div>
        <div className="text-5xl font-bold flex items-center text-primary mx-4">|</div>
      ...
      <section className="py-20 px-6 bg-background text-center">
        <h2 className="section-heading">Trending Jobs</h2>
        <p className="text-foreground opacity-80 mb-12 text-lg">
      ...
      <section className="bg-background py-16 px-6 text-center">
        ...
        <p className="text-gray-600 mb-10">28,48,723+ placements — read their stories</p>
